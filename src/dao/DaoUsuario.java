...
public class DaoUsuario {
	...
	public void salvar(BeanCursoJsp usuario) {
		...
		try {
			...
			String sql = "insert into usuario(login, senha, nome, fone, cep, rua, bairro, cidade, estado, ibge, fotobase64, contenttype, contenttypecurriculo, curriculobase64, fotobase64miniatura, ativo, sexo, perfil) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
/*Metodo para o input da pesquisa de usuario*/
	...
	/*Metodo de refatoraçao do metodo listar*/
	...
	public void atualizar(BeanCursoJsp usuario) {
		try {
			StringBuilder sql = new StringBuilder(); /*
														 * sql.append tem a funçao de deixar dinamico o fluxo de dados
														 * com o banco de dados, pois assim neste caso so atualiza o que
														 * for necessario.
														 */

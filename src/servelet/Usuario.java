		...
		try {
			...
			if (acao != null && acao.equalsIgnoreCase("delete")) {
				...
				if (usuario != null) {
					...
					int read = 0;
					byte[] bytes = new byte[1024]; /* "1024" e tamanho padrao */
			...
			try {
				...
				if (ServletFileUpload.isMultipartContent(request)) {
					...
					if (imagemFoto != null && imagemFoto.getInputStream().available() > 0) {
						...
						g.dispose(); /* metodo para finaliza o processo de escrever imagem novamnete */
